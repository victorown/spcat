...
- **Certainty Factor**: Metode yang digunakan untuk menghitung tingkat kepastian dalam pengambilan keputusan berdasarkan gejala atau kriteria yang diinput oleh pengguna.

## Fitur Utama

- **Pemilihan Cat Berdasarkan Kriteria**: Pengguna dapat memasukkan berbagai kriteria, seperti jenis permukaan, kondisi cuaca, dan preferensi warna, untuk mendapatkan rekomendasi jenis cat yang paling sesuai.
